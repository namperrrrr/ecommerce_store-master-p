                        ...
                        <div class="latest-product__text">
                            ...
                            <div class="latest-product__slider owl-carousel">
                                <div class="latest-prdouct__slider__item">
                                    ...
                                    ?>
                                        <a href="shop.php?id=<?= $row['id'] ?>" class="latest-product__item">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    <h6><a href="shop.php?id=<?= $row['id'] ?>"><?= $row['name'] ?></a></h6>
                                    <!-- <h5><?= $row['price'] ?></h5> -->
                                    <div class="prices">
                                        <span class="old"><?= $row['price'] ?></span>
                                        <span class="curr"><?= number_format($row['disscounted_price'], 0, '', '.') . " VNĐ" ?></span>
                                ...
                                <div class="col-lg-4">
                                    <div class="product__discount__item">
                                        ...
                                        <div class="product__discount__item__text">
                                            <span><?= $row['cname'] ?></span>
                                            <h5><a href="shop.php?id=<?= $row['pid'] ?>"><?= $row['pname'] ?></a></h5>
